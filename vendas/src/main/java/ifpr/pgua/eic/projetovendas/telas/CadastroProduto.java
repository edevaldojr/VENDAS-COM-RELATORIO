...
public class CadastroProduto {
    ...
    public CadastroProduto(Produto produtoAntigo, RepositorioProdutos repositorioProdutos){
    ...
    private void cadastrar(){
        ...
        if(!temErro){
            try{
                boolean ret = false;
                if(produtoAntigo != null){
                    ret = repositorioProdutos.atualizar(produtoAntigo.getId(), nome, descricao, quantidadeEstoque, valor);
                }else{
                    ret = repositorioProdutos.cadastrarProduto(nome, descricao, quantidadeEstoque, valor);
                }
