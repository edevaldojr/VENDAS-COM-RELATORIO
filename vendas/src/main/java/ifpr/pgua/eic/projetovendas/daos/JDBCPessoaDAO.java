...
public class JDBCPessoaDAO implements PessoaDAO {
    ...
    public boolean cadastrar(Pessoa p) throws Exception {
        ...
        String sql = "INSERT INTO ATIVIDADE_OO2_pessoa(nome,email,telefone) VALUES (?,?,?)";
    ...
    public boolean atualizar(int id, Pessoa p) throws Exception {
        ...
        String sql = "UPDATE ATIVIDADE_OO2_pessoa SET nome=?,email=?,telefone=? WHERE idPessoa=?";
    ...
    public boolean remover(int id) throws Exception {
        ...
        //String sql = "DELETE FROM ATIVIDADE_OO2_pessoa where idPessoa=?";

        String sql = "UPDATE ATIVIDADE_OO2_pessoa SET ativo=0 WHERE idPessoa=?";
    ...
    public ArrayList<Pessoa> listar() throws Exception {
        ...
        String sql = "SELECT * FROM ATIVIDADE_OO2_pessoa WHERE ativo=1";
    ...
    public Pessoa buscar(int id) throws Exception { 
        ...
        String sql = "SELECT * FROM ATIVIDADE_OO2_pessoa WHERE idPessoa=?";
    ...
    public Pessoa buscarPessoaVenda(int idVenda) throws Exception {
        ...
        String sqlIdPessoa = "SELECT idPessoa FROM ATIVIDADE_OO2_vendas WHERE id=?";
